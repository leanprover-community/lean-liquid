...
theorem short_exact (S : Profinite) [fact (r' < 1)] :
  short_exact
    ((condensify_map
      (whisker_right (invpoly.to_laurent_measures_nat_trans r') (PFPNG₁_to_CHFPNG₁ₗₑ r'))).app S)
    ((condensify_map
      (whisker_right (laurent_measures.to_Lbar_nat_trans r') (PFPNG₁_to_CHFPNG₁ₗₑ r'))).app S) :=
begin
