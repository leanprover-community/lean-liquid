...
def eval2_nat_trans :
  (Fintype.Laurent_measures.{u} r ⋙ to_CompHausFiltPseuNormGrp₁.{u} r) ⟶
...
lemma Tinv2_injective (S : Fintype) :
  function.injective ((Tinv2_nat_trans (Fintype.Laurent_measures r)).app S) :=
begin
...
lemma Tinv2_comp_eval2_eq_zero (S : Fintype) :
  (Tinv2_nat_trans (Fintype.Laurent_measures r)).app S ≫
