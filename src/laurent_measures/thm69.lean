...
variable (F : laurent_measures r (Fintype.of punit))
variable (s : S)
#check sum_smaller_radius r (Fintype.of punit) F punit.star
...
begin
  ...
  --   },
  -- have h_neg := sum_smaller_radius r (Fintype.of punit) ⟨f, hf⟩ (punit.star),
