...
Profinite.extend (Fintype_LaurentMeasures.{u} r' ⋙ PFPNGT₁_PFPNG₁_to_CHFPNG₁ₗₑₗₑ.{u} r')

def profinite_comp_PFPNGT₁_PFPNG₁_to_CHFPNG₁ₗₑₗₑ :
  laurent_measures.profinite.{u} r' ⋙ PFPNGT₁_PFPNG₁_to_CHFPNG₁ₗₑₗₑ.{u} r' ≅
  profiniteCH.{u} r' :=
