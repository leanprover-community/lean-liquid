...
begin
  ext s n,
  simp only [finset.sum_apply, Mbar.coe_sum, pi.smul_apply, Mbar.coe_zsmul,
    Mbar.coe_mk],
...
begin
  ...
  { simp only [Mbar.coe_zsmul, Mbar.mk_of_add_monoid_hom_to_fun, if_true,
  ...
  { simp only [hasn.symm, Mbar.coe_zsmul, pi.smul_apply, smul_eq_mul,
...
begin
  ...
  { simp only [add_monoid_hom.add_apply, add_assoc, add_monoid_hom.finset_sum_apply,
    ...
    { intros a ha, rw Mbar.nnnorm_zsmul },
