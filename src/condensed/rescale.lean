...
def rescale_enlarging_iso (r : ℝ≥0) [fact (0 < r)] :
  rescale r ⋙ CHFPNG₁_to_CHFPNGₗₑ ≅ CHFPNG₁_to_CHFPNGₗₑ :=
begin
...
def rescale_to_Condensed_iso (r : ℝ≥0) [fact (0 < r)] :
  ...
  CHFPNG₁_to_CHFPNGₗₑ ⋙ CompHausFiltPseuNormGrp.rescale r ⋙ CompHausFiltPseuNormGrp.to_Condensed :=
...
lemma strictify_nat_trans_enlarging {C : Type*} [category C]
  ...
  (α : F ⋙ CHFPNG₁_to_CHFPNGₗₑ.{u} ⟶ G ⋙ CHFPNG₁_to_CHFPNGₗₑ.{u}) (c : ℝ≥0) [fact (0 < c)]
  (h : ∀ X, (α.app X).bound_by c) :
  whisker_right (strictify_nat_trans α c h) CHFPNG₁_to_CHFPNGₗₑ =
...
lemma strictify_nat_trans_enlarging' {C : Type*} [category C]
  ...
  whisker_right (strictify_nat_trans α c h) CHFPNG₁_to_CHFPNGₗₑ = α :=
begin
  ext, refl,
end
...
variables (α β : F ⋙ CHFPNG₁_to_CHFPNGₗₑ ⟶ G ⋙ CHFPNG₁_to_CHFPNGₗₑ)
variables (c cα cβ cαβ : ℝ≥0) [fact (0 < c)] [fact (0 < cα)] [fact (0 < cβ)] [fact (0 < cαβ)]

def nonstrict_extend (α : F ⋙ CHFPNG₁_to_CHFPNGₗₑ ⟶ G ⋙ CHFPNG₁_to_CHFPNGₗₑ)
  (c : ℝ≥0) [fact (0 < c)] (h : ∀ X, (α.app X).bound_by c) :
  Profinite.extend.{u} F ⋙ CHFPNG₁_to_CHFPNGₗₑ ⟶ Profinite.extend.{u} G ⋙ CHFPNG₁_to_CHFPNGₗₑ :=
whisker_left (Profinite.extend F) (rescale_enlarging_iso.{u u} c).inv ≫
whisker_right ((Profinite.extend_commutes _ _).hom ≫
  Profinite.extend_nat_trans.{u} (strictify_nat_trans α c h)) CHFPNG₁_to_CHFPNGₗₑ
...
lemma nonstrict_extend_whisker_left (h : ∀ X, (α.app X).bound_by c) :
  ...
  whisker_right (Profinite.extend_extends.{u} F).hom CHFPNG₁_to_CHFPNGₗₑ.{u} ≫ α ≫
  whisker_right (Profinite.extend_extends.{u} G).inv CHFPNG₁_to_CHFPNGₗₑ.{u} ≫
...
lemma nonstrict_extend_ext'
  (α β : Profinite.extend.{u} F ⋙ CHFPNG₁_to_CHFPNGₗₑ ⟶ Profinite.extend G ⋙ CHFPNG₁_to_CHFPNGₗₑ)
...
begin
  ...
  refine ((whiskering_right _ _ _).obj CHFPNG₁_to_CHFPNGₗₑ.{u}).map_injective _,
...
lemma nonstrict_extend_id
  (hα : ∀ X, (nat_trans.app (𝟙 (F ⋙ CHFPNG₁_to_CHFPNGₗₑ.{u})) X).bound_by cα) :
...
lemma nonstrict_extend_whisker_right_enlarging (α : F ⟶ G) :
  nonstrict_extend (whisker_right α CHFPNG₁_to_CHFPNGₗₑ) 1
