...
{ factors := λ A B f g hg, begin
    ...
    change _ = f₁,
    rw ← h,
    rw hom_equiv_evaluation_apply,
    rw [Sheaf.hom.comp_val, nat_trans.comp_app],
    erw [← comp_apply, ← comp_apply, category.id_comp, ← nat_trans.comp_app,
      ← nat_trans.comp_app],
    ...
    simp_rw [comp_apply],
    congr' 1,
    dsimp [functor.preimage, yoneda'_equiv, full.preimage, AddCommGroup.adj,
      ulift_functor],
