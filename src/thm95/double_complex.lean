...
begin
  ...
  simp only [← nat_trans.app_hom_apply, add_monoid_hom.map_sum,
    ← differential_object.complex_like.f_hom_apply, this],
  apply normed_group_hom.bound_by.sum,
  rintro i -,
  fin_cases i,
  { simp only [fin.coe_zero, one_gsmul, differential_object.complex_like.f_hom_apply,
      pow_zero, nat_trans.app_hom_apply],
    apply normed_group_hom.norm_noninc.bound_by_one,
    apply breen_deligne.data.complex.map_norm_noninc },
  { simp only [fin.coe_one, neg_one_gsmul, differential_object.complex_like.f_hom_apply,
      pow_one, nat_trans.app_hom_apply],
    apply normed_group_hom.bound_by.neg,
    apply normed_group_hom.norm_noninc.bound_by_one,
    apply breen_deligne.data.complex.map_norm_noninc }
end
.
...
begin
  ...
  dsimp [system_of_complexes.rescale_functor, double_complex_aux, alt_face_map_cocomplex,
    system_of_complexes.rescale],
  rw [if_pos rfl, category.comp_id],
  dsimp [alt_face_map_cocomplex.d, alt_face_map_cocomplex.coboundary],
  simp only [← nat_trans.app_hom_apply, add_monoid_hom.map_sum, functor.map_sum,
    ← differential_object.complex_like.f_hom_apply, this],
  apply normed_group_hom.bound_by.sum,
  rintro i -,
  sorry
